...
public class BoardTest {
    ...
    public void testJump() {
        ...
        checkBoard("Blue's first move", B, 1, 1, 2, BLUE);
        B.addSpot(RED, 3, 3);
        checkBoard("After RED's first move", B, 1, 1, 2, BLUE, 3, 3, 2, RED);
        B.addSpot(BLUE, 1, 1);
        checkBoard("After Blue's second move", B, 1, 1, 1,
                BLUE, 3, 3, 2, RED, 1, 2, 2, BLUE, 2, 1, 2, BLUE);
        B.addSpot(BLUE, 2, 1);
        B.addSpot(RED, 1, 3);
        B.addSpot(BLUE, 2, 1);
        B.addSpot(RED, 3, 3);
    ...
    public void testThreeByThree() {
        Board B = new Board(2);
        B.addSpot(RED, 1, 1);
        assertEquals(B.numOfSide(RED), 1);
        checkBoard("First move", B, 1, 1, 2, RED);
        B.addSpot(RED, 1, 2);
        checkBoard("Second move", B, 1, 1, 2, RED, 1, 2, 2, RED);
        B.addSpot(RED, 2, 1);
        checkBoard("Third move", B, 1, 1, 2,
                RED, 1, 2, 2, RED, 2, 1, 2, RED);
        B.addSpot(RED, 2, 2);
        checkBoard("All red board", B, 1, 1, 2,
                RED, 1, 2, 2, RED, 2, 1, 2, RED, 2, 2, 2, RED);
    }
